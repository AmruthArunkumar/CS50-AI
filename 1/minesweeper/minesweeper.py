...
class Sentence():
    ...
    def mark_mine(self, cell):
        ...
        if cell in self.cells:
            ...
            # makes sure that the count doesn't go below 0
            # found on internet
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        cells = []
        # loop through cells without the center cell
        # found on internet how to loop through cells without center cell
        for i in range(cell[0] - 1, cell[0] + 2):
            for j in range(cell[1] - 1, cell[1] + 2):
        ...
        for i in range(len(self.knowledge)):
            for j in range(i + 1, len(self.knowledge)):
                ...
                if s1.cells.issubset(s2.cells):
                    new_cell = s2.cells - s1.cells
                    new_count = s2.count - s1.count
                    s = Sentence(cell, count)
                    if s not in self.knowledge:
                        self.knowledge.append(s)
                elif s2.cells.issubset(s1.cells):
                    new_cell = s1.cells - s2.cells
    ...
    def make_safe_move(self):
        ...
        """
        for spot in self.safes:
            if spot not in self.moves_made:
                return spot
        return None
